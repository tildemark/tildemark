...
export function HeroSection() {
  return (
    <section className="rounded-2xl bg-white dark:bg-zinc-900/70 border border-zinc-200 dark:border-zinc-800/80 overflow-hidden transition-colors shadow-xs">
      {/* Option 1: Top Cinematic Video Banner */}
      <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] max-h-[300px] overflow-hidden bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800">
        <video
          autoPlay
          loop
          muted
        ...
        {/* Subtle bottom gradient to blend into the card */}
